...
export function Post() { 
  ...
  //Cria uma referência do scroll e inicia vazio.
  const scrollRef = useRef<ScrollView>(null);

  //Pega as dimensões da janelado app.
  const dimensions = useWindowDimensions();

  //Calcula a porcentagem do deslocamento da tela através de dados enviados pelo scroll.
  function scrollPercentage({ contentOffset, contentSize, layoutMeasurement }: ScrollProps) {
